...
4. In `system.md`, add a parenthetical to the milestone dirs line (`M001-d24bw5/`) noting that with `unique_milestone_ids: true`, format is `M-{rand6}-{seq}/` (e.g. `M-eh88as-001/`). Keep it brief — this file is read every turn.

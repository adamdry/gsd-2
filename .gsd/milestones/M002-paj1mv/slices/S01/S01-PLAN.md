...
**Demo:** `nextMilestoneId([], true)` returns `M001-d24bw5-{rand6}` format; all 208 test assertions pass; grep confirms zero old-format traces.
...
- All 3 test files use `M001-d24bw5-abc123` style test data

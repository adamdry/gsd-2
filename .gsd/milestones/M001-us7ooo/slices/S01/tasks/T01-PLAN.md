...
5. Widen `findMilestoneIds()` regex from `/^(M\d+)/` to a pattern that captures both `M001` and `M-abc123-001` from directory names like `M001-us7ooo-CONTEXT` or `M-abc123-001/`

...
3. Create `src/resources/extensions/gsd/tests/integration-mixed-milestones.test.ts` with:
   ...
   - **Group 4: inlinePriorMilestoneSummary with mixed formats** (~5 assertions): Create `M001/` with `M001-us7ooo-SUMMARY.md` + `M-abc123-002/` as active. Call `inlinePriorMilestoneSummary("M-abc123-002", base)`. Assert result is non-null, contains M001's summary content.
